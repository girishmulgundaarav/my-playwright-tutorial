  ...
  tutorialSidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          type: 'doc',
          id: 'Labs/playwright-dom-labs',
          label: 'DOM & Locating Lab',
          className: 'sidebar-item-labs-dom',
        },
        {
          type: 'doc',
          id: 'Labs/playwright-calendars-labs',
          label: 'Calendars & Date Pickers Lab',
          className: 'sidebar-item-labs-calendars',
        },
        {
          type: 'doc',
          id: 'Labs/playwright-storage-labs',
          label: 'Storage & Authentication Lab',
          className: 'sidebar-item-labs-storage',
        },
        {
          type: 'doc',
          id: 'Labs/playwright-advanced-labs',
          label: 'Advanced Interactions Lab',
          className: 'sidebar-item-labs-advanced',
        },
        {
          type: 'doc',
          id: 'Labs/playwright-windows-labs',
          label: 'Multi-Tab & Window Triggers Lab',
          className: 'sidebar-item-labs-windows',
        },
        {
          type: 'doc',
          id: 'Labs/playwright-permissions-labs',
          label: 'Geolocation & Permissions Lab',
          className: 'sidebar-item-labs-permissions',
        },
        {
          type: 'doc',
          id: 'Labs/playwright-api-labs',
          label: 'Integrated API Sandbox Lab',
          className: 'sidebar-item-labs-api',
        },
        {
          type: 'doc',
          id: 'Labs/playwright-wizard-labs',
